...
class MySqlDataProvider extends DataProvider {
    ...
    public function get_users() {
        return $this->users_query('SELECT * FROM users');
    }
    ...
    public function get_term($term) {
        ...
        // TODO: Research prepared statements
    ...
    public function get_user($email) {
        ...
        $data = $smt->fetchAll(PDO::FETCH_CLASS, 'GlossaryUsers');
    ...
    // users_query
    private function users_query($sql, $sql_parms = []) {
        $db = $this->connect();
        ...
        $data = $query->fetchAll(PDO::FETCH_CLASS, 'GlossaryUsers');
